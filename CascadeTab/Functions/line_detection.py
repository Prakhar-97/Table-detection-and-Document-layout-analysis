...
def line_detection(image):
    ...
    filename = str(n) + "after_threshold.jpg"
    ...
    filename = str(n) + "hor_lines_highlighted.jpg"
    cv2.imwrite(filename, horizontal)'''

    ## Uncomment to visualize highlighted Horizontal lines
    # cv2_imshow("horizontal",horizontal)
    # cv2.waitKey(0)
    ...
    filename = str(n) + "hor_lines_detected.jpg"
    ...
    filename = str(n) + "ver_lines_detected.jpg"
    cv2.imwrite(filename, image)'''
    ...
    filename = str(n) + "all_lines_detected.jpg"
